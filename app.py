...
# ============= Bot Setup (runs on module load for production) =============

def setup_bot_sync():
    """Synchronous wrapper to set up the bot when the module is loaded."""
    global bot_app
...
# Initialize the bot when the module is loaded (works with Gunicorn)
setup_bot_sync()
