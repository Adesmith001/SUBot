...
AWAITING_FORM_STATUS, AWAITING_REG_NO_CHECK, REG_FIELD_INPUT, AWAITING_GENDER, AWAITING_COLLEGE, AWAITING_SUBUNIT, AWAITING_CONTACT, AWAITING_SEMESTER, AWAITING_REGISTERED_ALPHA = range(9)
